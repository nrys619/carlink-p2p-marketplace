...
function sanitizeListing(input, owner) {
  ...
  return {
    ...
    fuelType: ['ガソリン', 'ハイブリッド', 'EV', 'PHEV', 'ディーゼル', 'マイルドハイブリッド'].includes(input.fuelType) ? input.fuelType : undefined,
    driveType: ['2WD', '4WD', 'AWD', 'e-4WD'].includes(input.driveType) ? input.driveType : undefined,
    transmission: ['AT', 'CVT', 'MT', 'DCT'].includes(input.transmission) ? input.transmission : undefined,
    color: sanitizeString(input.color || '', 20) || undefined,
    numOwners: typeof input.numOwners === 'number' && input.numOwners >= 0 ? Math.min(input.numOwners, 10) : undefined,
    accidentHistory: typeof input.accidentHistory === 'boolean' ? input.accidentHistory : undefined,
  }
}
  ...
  return [
    {
      ...
      inspection: '2026年9月',
      verified: true,
      description: '屋内保管中心。整備記録簿あり。現車確認は週末対応可能です。修復歴なし。禁煙車。Toyota Safety Sense標準装備。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      inspection: '2027年2月',
      verified: true,
      description: '街乗り中心で使用。禁煙車、タイヤ溝も十分あります。記録簿1冊あり。Honda SENSING搭載済み。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      inspection: '2026年12月',
      verified: false,
      description: '長距離移動が多め。燃費重視の方に最適。ディーゼル車ならではの力強いトルク感です。BOSE9スピーカー搭載。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['アイサイトX', '4WD', '11.6インチナビ', 'ドライブレコーダー', 'シートヒーター'],
      inspection: '2026年7月',
      verified: true,
      description: 'アイサイトX付きで高速道路での移動が快適。主に家族でのドライブ利用。AWDで雪道も安心。11.6インチ縦型大画面ナビ搭載。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      inspection: '2027年1月',
      verified: true,
      description: 'ファミリー用に購入。子どもの通園・習い事送迎に活躍。e-POWERで燃費良好。プロパイロット搭載で高速移動も楽々。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['Toyota Safety Sense', 'パノラマルーフ', 'デジタルインナーミラー', 'AC100V', 'シートヒーター'],
      inspection: '2028年3月',
      verified: true,
      description: '新型60系プリウスZ。燃費約32km/L。パノラマガラスルーフ付き。修復歴なし、禁煙、屋根付き駐車場保管。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['EV', 'オートパイロット', 'ガラスルーフ', '航続距離603km', 'OTAアップデート'],
      inspection: '2027年6月',
      verified: true,
      description: 'ロングレンジAWDモデル。WLTP航続距離603km。オートパイロット搭載。自宅充電設備あり（充電ケーブル付属）。FSD購入可能。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['Executive Lounge', '後席オットマン', 'JBL', 'ツインムーンルーフ', '4人乗り'],
      inspection: '2028年8月',
      verified: true,
      description: '新型40系アルファード最上級グレード。Executive Loungeシート（4人乗り仕様）。JBL17スピーカー。ほぼ新車同様のコンディション。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['4WD', 'セーフティサポート', 'スノーモード', 'ETC', 'フォグランプ'],
      inspection: '2026年11月',
      verified: true,
      description: '雪山・キャンプに大活躍。パートタイム4WD。セーフティサポート搭載。スタッドレスタイヤ（別途相談可）。軽自動車のため維持費安。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['Toyota Safety Sense', 'マルチテレインモニター', '本革シート', 'クールボックス', 'パノラマルーフ'],
      inspection: '2027年4月',
      verified: true,
      description: '300系ランクルZX最上級。マルチテレインセレクト搭載。本革シート・カーゴクールボックス・パノラミックビューモニター完備。修復歴なし。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['Mスポーツ', 'ハーマンカードン', 'パノラマサンルーフ', 'ヘッドアップディスプレイ', 'ACC'],
      inspection: '2026年8月',
      verified: true,
      description: 'G20型320i Mスポーツ。正規ディーラー車。ハーマンカードン・ヘッドアップディスプレイ・ドライビングアシストプロフェッショナル搭載。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['Honda SENSING', 'e:HEV', 'シートヒーター', 'バックカメラ', 'スマートキー'],
      inspection: '2027年3月',
      verified: false,
      description: '4代目GR型フィットe:HEV HOME。燃費約27km/L。Honda SENSING全装備。女性1オーナー、禁煙、外装内装ともに良好です。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['EV', 'プロパイロット', 'e-Pedal', '62kWhバッテリー', 'V2H対応'],
      inspection: '2026年6月',
      verified: true,
      description: '62kWhバッテリー搭載のe+モデル。WLTPモード航続距離458km。プロパイロット搭載。V2H対応で災害時も安心。バッテリー残量95%。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['Toyota Safety Sense', '両側電動スライド', 'ディスプレイオーディオPlus', '後席モニター', 'ETC2.0'],
      inspection: '2027年5月',
      verified: true,
      description: '90系ヴォクシーS-Zハイブリッド。最上級グレード。ディスプレイオーディオPlus（後席モニター付き）・両側パワースライドドア完備。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      driveType: '2WD',
      transmission: 'CVT',
      color: 'ファイアークォーツレッドメタリック',
      numOwners: 1,
      accidentHistory: false,
      tags: ['スマートアシスト', 'ミラクルオープンドア', '両側電動スライド', 'ターボ', 'LEDヘッドライト'],
      inspection: '2027年7月',
      verified: false,
      description: '660ccターボエンジン搭載のカスタムRS。ミラクルオープンドアで乗り降り快適。スマートアシスト3搭載。1オーナー、禁煙車。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['TYPE R', '6MT', 'Brembo', 'レカロシート', 'Adaptive Damper System'],
      inspection: '2028年2月',
      verified: true,
      description: 'FL5型シビックTYPE R。6速MT。Bremboブレーキ・レカロバケットシート・アダプティブダンパーシステム標準装備。サーキット走行歴なし。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['6MT', 'Brembo', 'BOSE', 'レカロシート', '限定色'],
      inspection: '2026年10月',
      verified: true,
      description: 'ND5RC型ロードスターRS 6MT。Bremboブレーキ・レカロシート・BOSE9スピーカー搭載。ソフトトップ良好。週末オープンドライブ専用に大切に使用。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['PHEV', 'Toyota Safety Sense', 'パノラミックビューモニター', 'デジタルインナーミラー', '外部給電'],
      inspection: '2027年9月',
      verified: true,
      description: 'XA50系RAV4 PHEV StyleグレードE-Four。EV走行距離約95km。外部給電1500W対応。パノラミックビューモニター搭載。修復歴なし禁煙。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      driveType: '4WD',
      transmission: 'CVT',
      color: 'アクティブイエロー×ブラック2トーン',
      numOwners: 1,
      accidentHistory: false,
      tags: ['デュアルカメラブレーキサポート', '4WD', '全方位モニター', 'シートヒーター', 'スノーモード'],
      inspection: '2027年8月',
      verified: false,
      description: 'MR92S型ハスラーHBRTターボ4WD。マイルドハイブリッド。冬道も安心のスノーモード付き4WD。シートヒーター前後席装備。北海道使用車。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
    {
      id: 100020,
      sellerId: 'seed',
      sellerName: '西宮市の輸入車オーナー',
      title: 'メルセデス GLC',
      maker: 'メルセデス・ベンツ',
      grade: '220d 4MATIC AMGライン',
      year: '2022年',
      mileage: 29100,
      price: 6200000,
      location: '兵庫県 西宮市',
      ...
      numOwners: 1,
      accidentHistory: false,
      tags: ['AMGライン', 'Burmester', 'パノラミックスライディングルーフ', 'レザーエクスクルーシブ', 'AIRMATICサスペンション'],
      inspection: '2027年10月',
      verified: true,
      description: 'X254型GLC220d 4MATIC AMGライン。Burmesterサラウンドサウンド。AIRMATICサスペンション搭載。ディーラー整備記録完備。正規輸入車。',
      status: 'published',
      createdAt: now,
      updatedAt: now,
    },
